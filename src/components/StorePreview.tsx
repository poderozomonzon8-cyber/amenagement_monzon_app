...
function ProductCard({ product, index }) {
  ...
  return (
    <div
      ref={cardRef}
      className="group relative flex flex-col bg-white border border-gray-200 rounded-2xl overflow-hidden card-cinematic hover:border-gray-300 hover:shadow-xl hover:shadow-black/5"
    >
      ...
      <div className="flex items-center justify-between p-5 gap-4">
        ...
        <button
          ...
          className={[
            ...
            added ? "bg-green-500 scale-110" : "bg-charcoal hover:bg-secondary hover:scale-105",
          ].join(" ")}
        >
          {added ? (
        ...
        >
          <div>
            ...
            <p className="font-sans text-sm text-gray-500 mt-4 max-w-md leading-relaxed">
              Wear the brand. Carry the craft. Exclusive merchandise designed for those who appreciate quality in every detail.
            </p>
          </div>
