...
console.log("CONTACT SECTION ACTUAL");
              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-5" noValidate>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="flex flex-col gap-1.5">
                    <label htmlFor="name" className="font-mono text-[11px] uppercase tracking-widest text-gray-400">
                  ...
                  <div className="flex flex-col gap-1.5">
                    <label htmlFor="email" className="font-mono text-[11px] uppercase tracking-widest text-gray-400">
                ...
                <div className="flex flex-col gap-1.5">
                  <label htmlFor="phone" className="font-mono text-[11px] uppercase tracking-widest text-gray-400">
                    Phone
                  </label>
                  <input
                    id="phone"
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="flex flex-col gap-1.5">
                    <label htmlFor="projectType" className="font-mono text-[11px] uppercase tracking-widest text-gray-400">
                      Project Type
                    </label>
                    <select
                      id="projectType"
                  ...
                  <div className="flex flex-col gap-1.5">
                    <label htmlFor="budget" className="font-mono text-[11px] uppercase tracking-widest text-gray-400">
                      Budget Range
                    </label>
                    <select
                      id="budget"
                ...
                <div className="flex flex-col gap-1.5">
                  <label htmlFor="message" className="font-mono text-[11px] uppercase tracking-widest text-gray-400">
                  ...
                  <textarea
                    ...
                    className={`w-full px-4 py-3 text-sm font-sans text-charcoal bg-gray-50 border rounded-xl outline-none transition-all duration-200 focus:bg-white placeholder:text-gray-300 resize-none ${
                      errors.message ? "border-red-400" : "border-gray-200 focus:border-charcoal"
                    }`}
                  />
